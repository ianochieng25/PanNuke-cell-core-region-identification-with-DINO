...
class TransUNet(nn.Module):
    """
    TransUNet with variable input size support.
    - ViT-Small/8 backbone (embed_dim=384, patch_size=8)
    - Supports arbitrary H, W (must be divisible by patch_size)
    """
    def __init__(self, in_chans=3, num_classes=2, pretrained_vit=False):
        super().__init__()
        # 1. ViT Encoder
        ...
        # 2. Rebuild patch_embed to support arbitrary img_size
        ...
        # Save position embedding attributes
